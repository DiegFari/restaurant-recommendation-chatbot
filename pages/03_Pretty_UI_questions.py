...
st.set_page_config(page_title="Post-Chatbot Survey 1", page_icon="🗳️", layout="centered")
...
# Fixed schema — includes binary goal_check and both sets of questions
FIXED_COLS: List[str] = (
...
NEXT_PAGE = "pages/04_intermediate_task.py"
...
# Text labels for Likert; map to numeric scores
LIKERT_OPTIONS = [
    "Strongly disagree",
    "Disagree",
    "Neutral",
...
# ---------- UI ----------
st.title("🗳️ Post-Chatbot Survey 1")
...
# One-time shuffle per UI page for BASE_QUESTIONS
    ...
    if not user_id:
        ...
        row = {
            ...
            **{k: answers.get(k) for k, _ in NASA_QUESTIONS},
            ...
            "task_id": st.session_state.get("task1_id"), 
        }
        # Keep only fixed columns in consistent order
