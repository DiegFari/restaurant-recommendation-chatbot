...
st.markdown("<h2>Your second chatbot interaction</h2>", unsafe_allow_html=True)
...
<p>
In the next page, you will interact with another <b>chatbot</b>, also designed to help you select the 
<strong>best restaurant</strong> in town for your needs.
</p>
            
<p>
Let us quicly remind you the rules. 
</p>
            
<p>
Again you will be given a specific <b>task</b> to complete.  Your goal is to find the restaurant described in the task.  
You have <b> 5 minutes <b> to complete it — a timer will appear in the chat to help you keep track of time.  
The time is more than enough, so also here, <b>don’t rush!</b>  
Take your time to interact with the chatbot naturally and try to enjoy the conversation. You can either ask everything in one single message,  
...
click the <b>“I want to stop the interaction”</b> checkbox inside the chatbot interface.  
...
if st.button("I got it — Go to the chatbot"):
    st.switch_page("pages/06_ugly_gui_chat.py")
